...
// BASE SERVICE
import { EstudianteBaseService } from './base/estudiante.base.service';
...
/**
 * YOU CAN OVERRIDE HERE estudianteBaseService
 */
@Injectable()
export class EstudianteService extends EstudianteBaseService {
