...
function getConnection() {
	...
	global $db_evaluacionDocente_db_Url, $db_evaluacionDocente_db_User, $db_evaluacionDocente_db_Pass, $db_evaluacionDocente_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_evaluacionDocente_db_Url.";dbname=".$db_evaluacionDocente_db_DbName, $db_evaluacionDocente_db_User, $db_evaluacionDocente_db_Pass);
